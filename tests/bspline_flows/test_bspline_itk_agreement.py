...
def test_agrees_with_literal_itk_reconstruction_semantics(dimension):
    ...
    actual = CubicBSplineSynthesis(ImageDomain(output_size), chunk_size=11)(torch.from_numpy(coefficients_torch))[0]
...
def test_coefficient_lattice_geometry_matches_itk_formula():
    domain = ImageDomain((11, 9), spacing=(2.0, 3.0), origin=(10.0, 20.0), direction=((0.0, -1.0), (1.0, 0.0)))
